...
public class JpaRestriction {
	 ...
	 */
	private final JpaRestrictionType type;

	/**
	 * 조건 목록
	 */
	private final List<JpaCondition> conditionList = Lists.newArrayList();

	/**
	 * Child Predicate List
	 */
	private final List<JpaRestriction> childList = Lists.newArrayList();

	/**
	 * Fetch List
	 */
	private final List<JpaJoin> fetchList = Lists.newArrayList();
	...
	public JpaRestriction() {
		type = JpaRestrictionType.AND;
	}

	public JpaRestriction(JpaRestrictionType type) {
		this.type = type;
	}
	 ...
	 * Child Add
	 */
	public void addChild(JpaRestriction predicate) {
	...
	public void addFetch(String columnName, JoinType joinType) {
		this.fetchList.add(new JpaJoin(columnName, joinType));
	}
	// endregion
	...
	public void removeFetch(String columnName) {
		List<JpaJoin> fetchJoinList = this.fetchList.stream()
	...
	public void equals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.EQUALS)
	...
	public void notEquals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.NOT_EQUAL)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void equalsTrim(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.EQUALS_TRIM)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void notEqualsTrim(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.NOT_EQUALS_TRIM)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void in(String columnName, Collection<?> valueList) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.IN)
									  .columnName1(columnName)
									  .value1(valueList)
									  .build());
	}
	...
	public void notIn(String columnName, Collection<?> valueList) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.NOT_IN)
									  .columnName1(columnName)
									  .value1(valueList)
									  .build());
	}
	...
	public void lessThanEquals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.LESS_THAN_EQUAL)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void lessThanNotEquals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.LESS_THAN_NOT_EQUAL)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void greaterThanEquals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.GREATER_THAN_EQUAL)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void greaterThanNotEquals(String columnName, Object value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.GREATER_THAN_NOT_EQUAL)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void isNull(String columnName) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.IS_NULL)
									  .columnName1(columnName)
									  .build());
	}
	...
	public void isNotNull(String columnName) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.IS_NOT_NULL)
									  .columnName1(columnName)
									  .build());
	}
	...
	public void like(String columnName, String value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.LIKE)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void iLike(String columnName, String value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.ILIKE)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void notLike(String columnName, String value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.NOT_LIKE)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void notILike(String columnName, String value) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.NOT_ILIKE)
									  .columnName1(columnName)
									  .value1(value)
									  .build());
	}
	...
	public void between(String columnName, Object firstValue, Object lastValue) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.BETWEEN)
									  .columnName1(columnName)
									  .value1(firstValue)
									  .value2(lastValue)
									  .build());
	...
	public void columnValueEquals(String columnName1, String columnName2) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.COLUMN_EQUALS)
	...
	public void columnValueNotEquals(String columnName1, String columnName2) {
		conditionList.add(JpaCondition.builder()
									  .conditionType(JpaConditionType.COLUMN_NOT_EQUALS)
									  .columnName1(columnName1)
									  .columnName2(columnName2)
									  .build());
	}
	...
	public <T> Specification<T> toSpecification() {
		...
		Specification<T> specification = (root, query, criteriaBuilder) -> {
			...
			for (JpaCondition condition : conditionList) {
			...
			if (predicateList.size() > 1) {
				...
				return type == JpaRestrictionType.AND ? criteriaBuilder.and(ps) : criteriaBuilder.or(ps);
		...
		if (!childList.isEmpty()) {
			for (JpaRestriction child : childList) {
				specification = type == JpaRestrictionType.AND ? specification.and(child.toSpecification()) : specification.or(child.toSpecification());
			}
		}
	...
	private List<Predicate> getPredicateList(JpaConditionType conditionType,
											 Root<?> root,
